...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveRavenoxAgentDir() returns mainAgentDir
    process.env.RAVENOX_STATE_DIR = tmpDir;
    process.env.RAVENOX_AGENT_DIR = mainAgentDir;
