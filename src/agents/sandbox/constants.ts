...
export const DEFAULT_SANDBOX_IMAGE = .ravenox-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = .ravenox-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = .ravenox-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = .ravenox-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = .ravenox-sbx-browser-";
