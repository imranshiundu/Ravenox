...
function resolveWatchPaths(workspaceDir: string, config?: RavenoxConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: RavenoxConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: RavenoxConfig }) {
