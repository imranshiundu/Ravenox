...
import { createRavenoxCodingTools } from "./pi-tools.js";
...
*** End Patch`;
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createRavenoxCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createRavenoxCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createRavenoxCodingTools({
      config: cfg,
    ...
    const defaultTools = createRavenoxCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createRavenoxCodingTools({
      config: cfg,
    ...
    const bobTools = createRavenoxCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createRavenoxCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createRavenoxCodingTools({
      config: cfg,
