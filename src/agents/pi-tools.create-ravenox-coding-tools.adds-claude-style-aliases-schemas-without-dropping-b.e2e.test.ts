...
describe("createRavenoxCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createRavenoxCodingTools({
      config,
    ...
    const anthropicTools = createRavenoxCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createRavenoxCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createRavenoxCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
