...
const CLEANUP_STATE_KEY = Symbol.for(.ravenox.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for(.ravenox.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for(.ravenox.sessionWriteLockWatchdogState");
