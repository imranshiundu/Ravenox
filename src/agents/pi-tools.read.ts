...
function resolveAdaptiveReadMaxBytes(options?: RavenoxReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createRavenoxReadTool(base, {
...
export function createRavenoxReadTool(
  base: AnyAgentTool,
  options?: RavenoxReadToolOptions,
): AnyAgentTool {
