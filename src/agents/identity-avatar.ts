...
function resolveAvatarSource(cfg: RavenoxConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: RavenoxConfig, agentId: string): AgentAvatarResolution {
