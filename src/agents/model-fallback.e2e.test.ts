...
function makeCfg(overrides: Partial<RavenoxConfig> = {}): RavenoxConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): RavenoxConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): RavenoxConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
