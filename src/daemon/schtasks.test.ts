...
describe("resolveTaskScriptPath", () => {
  it.each([
    ...
    },
    {
      ...
      env: { USERPROFILE: "C:\\Users\\test", RAVENOX_PROFILE: "jbphoenix" },
      expected: path.join("C:\\Users\\test", ".ravenox-jbphoenix", "gateway.cmd"),
    },
    {
      name: "prefers RAVENOX_STATE_DIR over profile-derived defaults",
      env: {
...
describe("readScheduledTaskCommand", () => {
    ...
    await withScheduledTaskScript(
      {
        scriptLines: [
          "@echo off",
          '"C:\\Program Files\\nodejs\\node.exe" C:\\Users\\test\\AppData\\Roaming\\npm\\node_modules\.ravenox\\dist\\index.js gateway --port 18789',
        ],
      },
      async (env) => {
        const result = await readScheduledTaskCommand(env);
        expect(result).toEqual({
          programArguments: [
            "C:\\Program Files\\nodejs\\node.exe",
            "C:\\Users\\test\\AppData\\Roaming\\npm\\node_modules\.ravenox\\dist\\index.js",
            "gateway",
            "--port",
            "18789",
          ],
    ...
    await withScheduledTaskScript(
      {
        scriptLines: [
          "@echo off",
          '"\\\\fileserver\\Ravenox Share\\node.exe" "\\\\fileserver\\Ravenox Share\\dist\\index.js" gateway --port 18789',
        ],
      },
      async (env) => {
        const result = await readScheduledTaskCommand(env);
        expect(result).toEqual({
          programArguments: [
            "\\\\fileserver\\Ravenox Share\\node.exe",
            "\\\\fileserver\\Ravenox Share\\dist\\index.js",
            "gateway",
            "--port",
            "18789",
          ],
  ...
  it("reads script from RAVENOX_STATE_DIR override", async () => {
    await withScheduledTaskScript(
      {
        env: (tmpDir) => ({ RAVENOX_STATE_DIR: path.join(tmpDir, "custom-state") }),
