...
describe("resolveSystemdUserUnitPath", () => {
  it.each([
    ...
    },
    {
      ...
      env: {
        HOME: "/home/test",
        RAVENOX_PROFILE: "jbphoenix",
        RAVENOX_SYSTEMD_UNIT: "custom-unit",
      },
      expected: "/home/test/.config/systemd/user/custom-unit.service",
    },
    {
      name: "handles RAVENOX_SYSTEMD_UNIT with .service suffix",
      env: {
        HOME: "/home/test",
        RAVENOX_SYSTEMD_UNIT: "custom-unit.service",
      },
      expected: "/home/test/.config/systemd/user/custom-unit.service",
    },
    {
      name: "trims whitespace from RAVENOX_SYSTEMD_UNIT",
      env: {
        HOME: "/home/test",
        RAVENOX_SYSTEMD_UNIT: "  custom-unit  ",
      },
...
describe("systemd service control", () => {
  ...
  it("restarts a profile-specific user unit", async () => {
    ...
    await restartSystemdService({ stdout, env: { RAVENOX_PROFILE: "work" } });
