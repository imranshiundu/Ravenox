...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof RavenoxConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: RavenoxConfig; env: NodeJS.ProcessEnv }): {
  cfg: RavenoxConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
