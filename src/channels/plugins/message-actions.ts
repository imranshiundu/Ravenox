...
export function listChannelMessageActions(cfg: RavenoxConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: RavenoxConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: RavenoxConfig): boolean {
  for (const plugin of listChannelPlugins()) {
