...
export type ChannelAgentToolFactory = (params: { cfg?: RavenoxConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: RavenoxConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: RavenoxConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: RavenoxConfig }) => boolean;
  supportsCards?: (params: { cfg: RavenoxConfig }) => boolean;
