...
function setSlackDmPolicy(cfg: RavenoxConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Ravenox";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Ravenox`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: RavenoxConfig, allowFrom: string[]): RavenoxConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
