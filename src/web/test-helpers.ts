...
const CONFIG_KEY = Symbol.for(""ravenox:testConfigMock"");
...
vi.mock("@whiskeysockets/baileys", () => {
  ...
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for(""ravenox:lastSocket"")] =
    created.lastSocket;
  return created.mod;
});
...
export function getLastSocket(): MockBaileysSocket {
  const getter = (globalThis as Record<PropertyKey, unknown>)[Symbol.for(""ravenox:lastSocket"")];
  if (typeof getter === "function") {
