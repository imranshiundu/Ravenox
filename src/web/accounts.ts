...
export function listWhatsAppAuthDirs(cfg: RavenoxConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: RavenoxConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: RavenoxConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: RavenoxConfig): ResolvedWhatsAppAccount[] {
