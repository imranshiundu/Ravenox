...
function mergeSlackAccountConfig(cfg: RavenoxConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: RavenoxConfig): ResolvedSlackAccount[] {
