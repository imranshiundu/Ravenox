...
function resolveGatewayPort(cfg: RavenoxConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: RavenoxConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.RAVENOX_GATEWAY_PASSWORD?.trim() ||
