...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: RavenoxConfig): boolean {
...
export function summarizeBindings(cfg: RavenoxConfig, bindings: AgentBinding[]): string[] {
