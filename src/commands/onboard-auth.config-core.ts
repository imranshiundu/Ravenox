...
export function applyOpenrouterProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: RavenoxConfig): RavenoxConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: RavenoxConfig): RavenoxConfig {
...
export function applyMoonshotConfig(cfg: RavenoxConfig): RavenoxConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: RavenoxConfig): RavenoxConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: RavenoxConfig): RavenoxConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: RavenoxConfig): RavenoxConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: RavenoxConfig): RavenoxConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: RavenoxConfig): RavenoxConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: RavenoxConfig): RavenoxConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: RavenoxConfig): RavenoxConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: RavenoxConfig): RavenoxConfig {
...
export function applyQianfanProviderConfig(cfg: RavenoxConfig): RavenoxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: RavenoxConfig): RavenoxConfig {
