...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Ravenox status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand(.ravenox security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand(.ravenox security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.ravenox.ai/faq");
  runtime.log("Troubleshooting: https://docs.ravenox.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand(.ravenox status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand(.ravenox logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand(.ravenox status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand(.ravenox gateway probe")}`);
  }
}
