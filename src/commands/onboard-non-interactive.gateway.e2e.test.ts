...
describe("onboard (non-interactive): gateway and remote auth", () => {
  const prev = {
    ...
    skipBrowser: process.env.RAVENOX_SKIP_BROWSER_CONTROL_SERVER,
    token: process.env.RAVENOX_GATEWAY_TOKEN,
    password: process.env.RAVENOX_GATEWAY_PASSWORD,
  };
  ...
  afterAll(async () => {
    ...
    process.env.RAVENOX_STATE_DIR = prev.stateDir;
    process.env.RAVENOX_CONFIG_PATH = prev.configPath;
    process.env.RAVENOX_SKIP_CHANNELS = prev.skipChannels;
    process.env.RAVENOX_SKIP_GMAIL_WATCHER = prev.skipGmail;
    process.env.RAVENOX_SKIP_CRON = prev.skipCron;
    process.env.RAVENOX_SKIP_CANVAS_HOST = prev.skipCanvas;
    process.env.RAVENOX_SKIP_BROWSER_CONTROL_SERVER = prev.skipBrowser;
    process.env.RAVENOX_GATEWAY_TOKEN = prev.token;
    process.env.RAVENOX_GATEWAY_PASSWORD = prev.password;
  });
