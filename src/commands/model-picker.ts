...
type PromptDefaultModelResult = { model?: string; config?: RavenoxConfig };
...
function resolveConfiguredModelRaw(cfg: RavenoxConfig): string {
...
export function applyPrimaryModel(cfg: RavenoxConfig, model: string): RavenoxConfig {
...
export function applyModelAllowlist(cfg: RavenoxConfig, models: string[]): RavenoxConfig {
  const defaults = cfg.agents?.defaults;
