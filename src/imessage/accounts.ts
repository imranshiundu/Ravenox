...
function mergeIMessageAccountConfig(cfg: RavenoxConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: RavenoxConfig): ResolvedIMessageAccount[] {
