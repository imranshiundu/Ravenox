...
function resolveMentionPatterns(cfg: RavenoxConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: RavenoxConfig | undefined, agentId?: string): RegExp[] {
