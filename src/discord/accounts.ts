...
function mergeDiscordAccountConfig(cfg: RavenoxConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: RavenoxConfig): ResolvedDiscordAccount[] {
