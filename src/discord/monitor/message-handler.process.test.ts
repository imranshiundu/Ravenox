...
const resolveStorePath = vi.fn(() => "/tmp.ravenox-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp.ravenox-discord-process-test-sessions.json");
});
