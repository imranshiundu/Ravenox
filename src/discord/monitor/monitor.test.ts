...
describe("agent components", () => {
  const createCfg = (): RavenoxConfig => ({}) as RavenoxConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp.ravenox-sessions-test.json");
  });
