...
beforeAll(async () => {
  previousToken = process.env.RAVENOX_GATEWAY_TOKEN;
  process.env.RAVENOX_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: .ravenox-ios", platform: "ios" },
  { clientId: .ravenox-android", platform: "android" },
