...
import type { RavenoxConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: RavenoxConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: RavenoxConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: RavenoxConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: RavenoxConfig) => void;
  log: {
