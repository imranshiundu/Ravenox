...
export function resolveHooksConfig(cfg: RavenoxConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: RavenoxConfig, defaultAgentId: string): Set<string> {
