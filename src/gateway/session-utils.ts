...
import { type RavenoxConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: RavenoxConfig): string[] {
...
export function listAgentsForGateway(cfg: RavenoxConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: RavenoxConfig): string {
...
function resolveSessionStoreAgentId(cfg: RavenoxConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: RavenoxConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: RavenoxConfig): GatewaySessionsDefaults {
