...
function mergeSignalAccountConfig(cfg: RavenoxConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: RavenoxConfig): ResolvedSignalAccount[] {
