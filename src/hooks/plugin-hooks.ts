...
import type { RavenoxPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: RavenoxPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: RavenoxPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
