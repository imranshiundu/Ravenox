...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.RAVENOX_BUNDLED_HOOKS_DIR;
    process.env.RAVENOX_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      delete process.env.RAVENOX_BUNDLED_HOOKS_DIR;
    } else {
      process.env.RAVENOX_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });
