...
function isTelegramConfigured(cfg: RavenoxConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: RavenoxConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: RavenoxConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: RavenoxConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: RavenoxConfig): boolean {
...
function isIMessageConfigured(cfg: RavenoxConfig): boolean {
...
function isWhatsAppConfigured(cfg: RavenoxConfig): boolean {
...
function isGenericChannelConfigured(cfg: RavenoxConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: RavenoxConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: RavenoxConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: RavenoxConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: RavenoxConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: RavenoxConfig, pluginId: string): RavenoxConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
