...
function resolveAnthropicDefaultAuthMode(cfg: RavenoxConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: RavenoxConfig): RavenoxConfig {
...
export function applyTalkApiKey(config: RavenoxConfig): RavenoxConfig {
...
export function applyModelDefaults(cfg: RavenoxConfig): RavenoxConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: RavenoxConfig): RavenoxConfig {
...
export function applyLoggingDefaults(cfg: RavenoxConfig): RavenoxConfig {
...
export function applyContextPruningDefaults(cfg: RavenoxConfig): RavenoxConfig {
...
export function applyCompactionDefaults(cfg: RavenoxConfig): RavenoxConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
