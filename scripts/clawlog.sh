...
show_usage() {
    cat << EOF
clawlog - Ravenox Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Ravenox logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Ravenox logs flow through the macOS unified log (subsystem: ai.ravenox).
