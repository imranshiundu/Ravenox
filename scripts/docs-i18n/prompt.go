...
- Keep product names in English: Ravenox, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Ravenox Gateway, use “Gateway 网关”.
