...
# Output:
# - dist/Ravenox.app
# - dist/Ravenox-<version>.zip
# - dist/Ravenox-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Ravenox-$VERSION.zip"
DMG="$ROOT_DIR/dist/Ravenox-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Ravenox-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Ravenox-$VERSION.dSYM.zip"
