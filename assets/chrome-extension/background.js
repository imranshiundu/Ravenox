...
function onRelayClosed(reason) {
  ...
  for (const tabId of tabs.keys()) {
    ...
    void chrome.action.setTitle({
      tabId,
      title: 'Ravenox Browser Relay: disconnected (click to re-attach)',
    })
  }
  tabs.clear()
  tabBySession.clear()
...
async function attachTab(tabId, opts = {}) {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'Ravenox Browser Relay: attached (click to detach)',
  })
...
async function detachTab(tabId, reason) {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'Ravenox Browser Relay (click to attach/detach)',
  })
}
...
async function connectOrToggleForActiveTab() {
  ...
  void chrome.action.setTitle({
    tabId,
    title: 'Ravenox Browser Relay: connecting to local relay…',
  })
  ...
  try {
    ...
    void chrome.action.setTitle({
      tabId,
      title: 'Ravenox Browser Relay: relay not running (open options for setup)',
    })
