...
This guide summarizes a sane workflow for working on the pi integration in Ravenox.
...
- Trigger the agent directly:
  - `pnpm.ravenox agent --message "Hello" --thinking low`
...
State lives under the Ravenox state directory. Default is `~/.ravenox`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- .ravenox.json` for config
...
- [https://docs.ravenox.ai/testing](https://docs.ravenox.ai/testing)
- [https://docs.ravenox.ai/start/getting-started](https://docs.ravenox.ai/start/getting-started)
