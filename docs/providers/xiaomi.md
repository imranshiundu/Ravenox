---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Ravenox"
read_when:
  - You want Xiaomi MiMo models in Ravenox
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Ravenox uses
