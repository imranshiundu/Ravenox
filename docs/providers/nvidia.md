---
summary: "Use NVIDIA's OpenAI-compatible API in Ravenox"
read_when:
  - You want to use NVIDIA models in Ravenox
...
ravenox onboard --auth-choice skip
ravenox models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
