---
summary: "Use Qwen OAuth (free tier) in Ravenox"
read_when:
  - You want to use Qwen with Ravenox
...
If you already logged in with the Qwen Code CLI, Ravenox will sync credentials
