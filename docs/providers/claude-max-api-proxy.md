...
You can point Ravenox at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Ravenox
...
- [Anthropic provider](/providers/anthropic) - Native Ravenox integration with Claude setup-token or API keys
