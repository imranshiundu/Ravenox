---
summary: "Use Qianfan's unified API to access many models in Ravenox"
read_when:
...
3. Ravenox installed on your system
...
4. Copy the API key for use with Ravenox

## CLI setup

```bash
ravenox onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Ravenox Configuration](/gateway/configuration)
