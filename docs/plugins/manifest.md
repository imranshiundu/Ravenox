...
read_when:
  - You are building a Ravenox plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest .ravenox.plugin.json)

Every plugin **must** ship a .ravenox.plugin.json` file in the **plugin root**.
Ravenox uses this manifest to validate configuration **without executing plugin
