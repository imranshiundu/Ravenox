...
```bash
ravenox plugins install ./extensions/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "Ravenox" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - .ravenox pairing list nextcloud-talk`
  - .ravenox pairing approve nextcloud-talk <CODE>`
