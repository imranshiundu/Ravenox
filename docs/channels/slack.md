...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Ravenox HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses .ravenox pairing approve slack <code>`.
...
Ravenox supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Ravenox falls back to normal delivery for remaining payloads.
