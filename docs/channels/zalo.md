...
- Install via CLI: .ravenox plugins install "@ravenox/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: .ravenox plugins install ./extensions/zalo`
   - From npm (if published): .ravenox plugins install "@ravenox/zalo`
...
- Approve via:
  - .ravenox pairing list zalo`
  - .ravenox pairing approve zalo <CODE>`
...
- Example: .ravenox message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: .ravenox channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: .ravenox logs --follow`
