...
本指南总结了在 Ravenox 中开发 Pi 集成的合理工作流程。
...
状态存储在 Ravenox 状态目录下。默认为 `~/.ravenox`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.ravenox.ai/testing
- https://docs.ravenox.ai/start/getting-started
