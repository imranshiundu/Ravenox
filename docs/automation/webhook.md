...
read_when:
  ...
  - Wiring external systems into Ravenox
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Ravenox config directory (typically `~/.ravenox/hooks/transforms`).
...
- .ravenox webhooks gmail setup` writes `hooks.gmail` config for .ravenox webhooks gmail run`.
