---
summary: "Ravenox on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up Ravenox on DigitalOcean
  - Looking for cheap VPS hosting for Ravenox
title: "DigitalOcean"
---

# Ravenox on DigitalOcean

## Goal

Run a persistent Ravenox Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
# View logs
journalctl --user -u.ravenox-gateway.service -f
```
...
- `~/.ravenox/workspace/` — workspace (SOUL.md, memory, etc.)
