...
- Same path: run the app from a fixed location (for Ravenox, `dist/Ravenox.app`).
...
Workaround: move files into the Ravenox workspace (`~/"@ravenox/workspace`) if you want to avoid per-folder grants.
