---
summary: "Ravenox macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
  - Cutting or validating a Ravenox macOS release
  - Updating the Sparkle appcast or feed assets
title: "macOS Release"
---

# Ravenox macOS release (Sparkle)
...
- Notary credentials (keychain profile or API key) for `xcrun notarytool` if you want Gatekeeper-safe DMG/zip distribution.
  - We use a Keychain profile named .ravenox-notary`, created from App Store Connect API key env vars in your shell profile:
...
ditto -c -k --sequesterRsrc --keepParent dist/Ravenox.app dist/Ravenox-2026.2.18.zip

# Optional: also build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/Ravenox.app dist/Ravenox-2026.2.18.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/Ravenox.app.dSYM dist/Ravenox-2026.2.18.dSYM.zip
```
