---
summary: "Advanced setup and development workflows for Ravenox"
read_when:
...
If you don’t have a global install yet, run it via `pnpm.ravenox setup`.
...
1. Install + launch **Ravenox.app** (menu bar).
...
- Run .ravenox setup`, then .ravenox channels login`, then start the Gateway manually (.ravenox gateway`).
...
- [Ravenox assistant setup](/start.ravenox)
