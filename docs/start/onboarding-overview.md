---
summary: "Overview of Ravenox onboarding options and flows"
read_when:
...
Ravenox supports multiple onboarding paths depending on where the Gateway runs
...
- [.ravenox onboard` command](/cli/onboard)

## macOS app onboarding

Use the Ravenox app when you want a fully guided setup on macOS. Docs:
