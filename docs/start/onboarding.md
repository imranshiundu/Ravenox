---
summary: "First-run onboarding flow for Ravenox (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Ravenox">
...
<Step title="CLI">
  ...
  The app can install the global .ravenox` CLI via npm/pnpm so terminal
