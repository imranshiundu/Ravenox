---
summary: "Backstory and lore of Ravenox for context and tone"
read_when:
...
In the end, **Ravenox** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around Ravenox. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Ravenox): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: .ravenox what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with.ravenox."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped .ravenox. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Ravenox" to promote pump-and-dump tokens.
...
- GitHub renamed: `github.com.ravenox.ravenox` ✅
- X handle `.ravenox` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.ravenox.ai`
