---
summary: "Frequently asked questions about Ravenox setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Ravenox?](#whats-the-recommended-way-to-install-and-set-up.ravenox)
  ...
  - [I can't access docs.ravenox.ai (SSL error). What now?](#i-cant-access-doc.ravenoxai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or.ravenox not recognized](#windows-install-says-git-not-found-or.ravenox-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Ravenox on Linux?](#how-do-i-install.ravenox-on-linux)
  - [How do I install Ravenox on a VPS?](#how-do-i-install.ravenox-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Ravenox to update itself?](#can-i-ask.ravenox-to-update-itself)
  ...
  - [If I buy a Mac mini to run Ravenox, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run.ravenox-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Ravenox instances?](#can-multiple-people-use-one-whatsapp-number-with-different.ravenox-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Ravenox on a dedicated machine?](#how-important-is-it-to-run.ravenox-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Ravenox in a VM and what are the requirements](#can-i-run.ravenox-in-a-vm-and-what-are-the-requirements)
- [What is Ravenox?](#what-is.ravenox)
  - [What is Ravenox, in one paragraph?](#what-is.ravenox-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Ravenox](#what-are-the-top-five-everyday-use-cases-for.ravenox)
  - [Can Ravenox help with lead gen outreach ads and blogs for a SaaS](#can.ravenox-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Ravenox run tasks on a schedule or continuously in the background?](#can.ravenox-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Ravenox saved locally?](#is-all-data-used-with.ravenox-saved-locally)
  - [Where does Ravenox store its data?](#where-does.ravenox-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Ravenox?](#how-do-i-completely-uninstall.ravenox)
...
- [Config basics](#config-basics)
  ...
  - [Can the Ravenox browser run headless?](#can-the.ravenox-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Ravenox instances talk to each other (local + VPS)?](#can-two.ravenox-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Ravenox load environment variables?](#how-does.ravenox-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Ravenox instances one CEO and many agents](#is-there-a-way-to-make-a-team-of.ravenox-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Ravenox but keep it installed?](#how-do-i-completely-reset.ravenox-but-keep-it-installed)
  ...
  - [Why doesn't Ravenox reply in a group?](#why-doesnt.ravenox-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Ravenox, Flawd, and Krill use for models?](#what-do.ravenox-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does .ravenox gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does.ravenox-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does .ravenox gateway status` show `Config (cli)` and `Config (service)` different?](#why-does.ravenox-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Ravenox in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run.ravenox-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Ravenox?](#i-closed-my-terminal-on-windows-how-do-i-restart.ravenox)
  ...
  - [ELI5: .ravenox gateway restart` vs .ravenox gateway`](#eli5.ravenox-gateway-restart-vs.ravenox-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Ravenox to inbound DMs?](#is-it-safe-to-expose.ravenox-to-inbound-dms)
...
5. **Tail the latest log**
  ...
  .ravenox logs --follow
   ...
   ```bash
   tail -f "$(ls -t /tmp.ravenox.ravenox-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
  .ravenox health --json
  .ravenox health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https:/.ravenox.ai/install.sh | bash -s -- --install-method git
```

This installs Ravenox **from a git checkout**, so the agent can read the code + docs and
...
```bash
ravenox status
ravenox models status
ravenox doctor
```

What they do:

- .ravenox status`: quick snapshot of gateway/agent health + basic config.
- .ravenox models status`: checks provider auth + model availability.
- .ravenox doctor`: validates and repairs common config/state issues.

Other useful CLI checks: .ravenox status --all`, .ravenox logs --follow`,
.ravenox gateway status`, .ravenox health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Ravenox
...
If you don't have a global install yet, run it via `pnpm.ravenox onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `RAVENOX_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: .ravenox config get gateway.auth.token` (or generate one: .ravenox doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run .ravenox gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run .ravenox gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
### I cant access docs.ravenox.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.ravenox.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.ravenox.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#doc.ravenoxai-shows-an-ssl-error-comcastxfinity).
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https:/.ravenox.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https:/.ravenox.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https:/.ravenox.ai/install.ps1](https:/.ravenox.ai/install.ps1)
...
```bash
curl -fsSL https:/.ravenox.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https:/.ravenox.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https:/.ravenox.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https:/.ravenox.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or.ravenox not recognized
...
**2).ravenox is not recognized after install**
...
### How do I install Ravenox on Linux
...
### How do I install Ravenox on a VPS
...
### Can I ask Ravenox to update itself
...
ravenox update --channel stable|beta|dev
ravenox update --tag <dist-tag|version>
ravenox update --no-restart
```

If you must automate from an agent:

```bash
ravenox update --yes --no-restart
ravenox gateway restart
```
...
.ravenox onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Ravenox with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with .ravenox models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use .ravenox models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with .ravenox models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Ravenox no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Ravenox can keep replying while a provider is rate-limited.
...
Ravenox supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Ravenox fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in .ravenox.json`.

Steps:

1. Enable the plugin: .ravenox plugins enable google-gemini-cli-auth`
2. Login: .ravenox models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Ravenox needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Ravenox runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Ravenox can I connect it to my MacBook Pro
...
- Use .ravenox nodes status` / .ravenox nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but Ravenox authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run .ravenox logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Ravenox instances
...
If you run Ravenox via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
**Ravenox-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Ravenox on a dedicated machine
...
Ravenox is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Ravenox in a VM and what are the requirements
...
### What is Ravenox in one paragraph

Ravenox is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Ravenox is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Ravenox
...
### Can Ravenox help with lead gen outreach ads and blogs for a SaaS
...
Ravenox draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Ravenox is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Ravenox when you
...
Showcase: [https:/.ravenox.ai/showcase](https:/.ravenox.ai/showcase)
...
- Confirm cron is enabled (`cron.enabled`) and `RAVENOX_SKIP_CRON` is not set.
...
```bash
ravenox cron run <jobId> --force
ravenox cron runs --id <jobId> --limit 50
```
...
### Can Ravenox run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.ravenox.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run.ravenox-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Ravenox can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
```bash
ravenox browser extension install
ravenox browser extension path
```
...
- Persist `/home/node` with `RAVENOX_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `RAVENOX_DOCKER_APT_PACKAGES`.
...
Ravenox memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Ravenox also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Ravenox auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Ravenox
prefers `local`.
...
### Is all data used with Ravenox saved locally

No - **Ravenox's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.ravenox` + your workspace directory).
...
### Where does Ravenox store its data

Everything lives under `$RAVENOX_STATE_DIR` (default: `~/.ravenox`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$RAVENOX_STATE_DIR.ravenox.json`                             | Main config (JSON5)                                          |
| `$RAVENOX_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$RAVENOX_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$RAVENOX_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$RAVENOX_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$RAVENOX_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
...
These files live in the **agent workspace**, not `~/.ravenox`.
...
Do **not** commit anything under `~/.ravenox` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Ravenox
...
`workspace` to the repo root. The Ravenox repo is just source code; keep the
...
Ravenox reads an optional **JSON5** config from `$RAVENOX_CONFIG_PATH` (default: `~/.ravenox.ravenox.json`):
...
Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `RAVENOX_GATEWAY_TOKEN`).
...
Ravenox enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: .ravenox doctor --generate-gateway-token`.
...
key. **Recommended:** run .ravenox configure --section web` to store it in
...
### Can the Ravenox browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
  .ravenox nodes pending
  .ravenox nodes approve <requestId>
   ```
...
- Gateway is running: .ravenox gateway status`
- Gateway health: .ravenox status`
- Channel health: .ravenox channels status`
...
### Can two Ravenox instances talk to each other local VPS
...
.ravenox agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
ravenox agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.ravenox.ravenox.json`).
- If you have no backup, re-run .ravenox doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use .ravenox config set` for small changes.
- Use .ravenox configure` for interactive edits.
...
```bash
ravenox gateway --tailscale serve
```
...
### How does Ravenox load environment variables
...
`RAVENOX_LOAD_SHELL_ENV=1`, `RAVENOX_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

.ravenox models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Ravenox won't load
...
### Is there a way to make a team of Ravenox instances one CEO and many agents
...
### How do I completely reset Ravenox but keep it installed
...
```bash
ravenox reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `RAVENOX_PROFILE`), reset each state dir (defaults are `~/.ravenox-<profile>`).
- Dev reset: .ravenox gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Ravenox skips the heartbeat run to save API calls.
...
No. Ravenox runs on **your own account**, so if you're in the group, Ravenox can see it.
...
```bash
ravenox directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Ravenox reply in a group
...
- Use .ravenox doctor` to spot stray workspaces and profile mismatches.
...
Ravenox's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Ravenox currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- .ravenox models set ...` (updates just model config)
- .ravenox configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.ravenox.ravenox.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run .ravenox doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Ravenox, Flawd, and Krill use for models

- **Ravenox + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. Ravenox ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run .ravenox agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Ravenox can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Sanity-check model/auth status**
  - Use .ravenox models status` to see configured models and whether providers are authenticated.
...
- **If you want to use an API key instead**
  ...
  - Clear any pinned order that forces a missing profile:
    ...
    ```bash
   .ravenox models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Ravenox will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Ravenox now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Ravenox uses provider-prefixed IDs like:
...
Ravenox may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run .ravenox models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
ravenox models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
ravenox models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
ravenox models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
ravenox models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

Ravenox supports both:
...
```
--port > RAVENOX_GATEWAY_PORT > gateway.port > default 18789
```

### Why does.ravenox gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use .ravenox gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does.ravenox gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `RAVENOX_STATE_DIR` mismatch).

Fix:

```bash
ravenox gateway install --force
```
...
Ravenox enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with .ravenox gateway --port <port>`.

### How do I run Ravenox in remote mode client connects to a Gateway elsewhere
...
- .ravenox gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key .ravenox.control.settings.v1`.

Fix:

- Fastest: .ravenox dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: .ravenox doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `RAVENOX_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run .ravenox status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `RAVENOX_CONFIG_PATH` (per-instance config)
- `RAVENOX_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use .ravenox --profile <name> …` per instance (auto-creates `~/.ravenox-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: .ravenox --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.ravenox.*`, .ravenox-gateway-<profile>.service`, `Ravenox Gateway (<profile>)`).
...
```
ravenox tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp.ravenox.ravenox-YYYY-MM-DD.log
```
...
If you run the gateway manually, .ravenox gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Ravenox
...
1. Is the Gateway running? .ravenox gateway status`
2. Is the Gateway healthy? .ravenox status`
3. Does the UI have the right token? .ravenox dashboard`
...
```bash
ravenox channels status
ravenox channels logs --channel telegram
```
...
### ELI5.ravenox gateway restart vs.ravenox gateway

- .ravenox gateway restart`: restarts the **background service** (launchd/systemd).
- .ravenox gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use .ravenox gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Ravenox assistant setup](/start.ravenox) and [Agent send](/tools/agent-send).

CLI sending:

```bash
ravenox message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Ravenox to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: .ravenox pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check .ravenox pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run .ravenox doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Ravenox only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
ravenox pairing approve whatsapp <code>
```

List pending requests:

```bash
ravenox pairing list whatsapp
```
...
Ravenox blocks **cross-provider** messaging by default. If a tool call is bound
