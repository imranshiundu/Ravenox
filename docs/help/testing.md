...
- `OPENCLAW_CONFIG_DIR=...` (default: `~/.ravenox`) mounted to `/home/node/.ravenox`
- `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.ravenox/workspace`) mounted to `/home/node/.ravenox/workspace`
