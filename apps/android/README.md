## Ravenox Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`.ravenox-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm.ravenox gateway --port 18789 --verbose
```
