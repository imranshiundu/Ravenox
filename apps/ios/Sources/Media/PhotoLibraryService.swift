...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: RavenoxPhotosLatestParams) async throws -> RavenoxPhotosLatestPayload {
        ...
        var results: [RavenoxPhotoPayload] = []
        ...
        return RavenoxPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> RavenoxPhotoPayload
    {
