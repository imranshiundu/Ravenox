...
public typealias RavenoxPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias RavenoxPlatformImage = UIImage
#endif

public struct RavenoxChatUsageCost: Codable, Hashable, Sendable {
...
public struct RavenoxChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: RavenoxChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(RavenoxChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct RavenoxChatMessageContent: Codable, Hashable, Sendable {
...
public struct RavenoxChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [RavenoxChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: RavenoxChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [RavenoxChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: RavenoxChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(RavenoxChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([RavenoxChatMessageContent].self, forKey: .content) {
...
public struct RavenoxChatHistoryPayload: Codable, Sendable {
...
public struct RavenoxSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct RavenoxSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [RavenoxSessionPreviewItem]
}

public struct RavenoxSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [RavenoxSessionPreviewEntry]

    public init(ts: Int, previews: [RavenoxSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct RavenoxChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct RavenoxChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct RavenoxAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct RavenoxChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct RavenoxGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct RavenoxPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: RavenoxPlatformImage?
...
public struct RavenoxChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
