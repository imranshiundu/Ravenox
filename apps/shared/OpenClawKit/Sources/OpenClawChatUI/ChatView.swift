...
@MainActor
public struct RavenoxChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: RavenoxChatViewModel
    ...
    public init(
        viewModel: RavenoxChatViewModel,
    ...
    private var visibleMessages: [RavenoxChatMessage] {
        let base: [RavenoxChatMessage]
    ...
    private func mergeToolResults(in messages: [RavenoxChatMessage]) -> [RavenoxChatMessage] {
    ...
    private func isToolResultMessage(_ message: RavenoxChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: RavenoxChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: RavenoxChatMessage) -> String {
