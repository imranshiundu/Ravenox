...
public enum RavenoxCanvasA2UICommand: String, Codable, Sendable {
...
public struct RavenoxCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct RavenoxCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
