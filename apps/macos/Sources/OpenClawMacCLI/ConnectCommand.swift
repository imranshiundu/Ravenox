...
struct ConnectOptions {
    ...
    var clientId: String = .ravenox-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
       ...
       .ravenox-mac connect
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default:.ravenox-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "Ravenox macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("Ravenox macOS Gateway Connect")
