...
enum UIStrings {
    static let welcomeTitle = "Welcome to Ravenox"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: .ravenox.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: RavenoxOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: RavenoxChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g.ravenox@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: RavenoxChatViewModel(
