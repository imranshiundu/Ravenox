...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.ravenox", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Ravenox/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("_.ravenox__/a2ui/").absoluteString + "?platform=macos"
    }
