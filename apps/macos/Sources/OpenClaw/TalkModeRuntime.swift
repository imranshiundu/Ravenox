...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.ravenox", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.ravenox", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [RavenoxChatMessage] = messages.compactMap { item in
