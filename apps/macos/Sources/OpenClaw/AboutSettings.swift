...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com.ravenox.ravenox") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com.ravenox.ravenox")
                AboutLinkRow(icon: "globe", title: "Website", url: "https:/.ravenox.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "RavenoxBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "RavenoxBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "RavenoxGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "RavenoxGitCommit") as? String) ??
            "unknown"
    }
