...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.ravenox", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return RavenoxConfigFile.defaultWorkspaceURL() }
