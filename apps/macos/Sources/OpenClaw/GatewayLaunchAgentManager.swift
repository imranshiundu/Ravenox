...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.ravenox", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".ravenox/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.ravenoxCommand(
            subcommand: "gateway",
