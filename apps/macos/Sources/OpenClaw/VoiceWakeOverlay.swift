...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.ravenox", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Ravenox windows, but below the system’s pop-up menus.
