...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .ravenoxSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? RavenoxPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? RavenoxPaths.stateDirURL.path
...
extension Notification.Name {
    static let.ravenoxSelectSettingsTab = Notification.Name(.ravenoxSelectSettingsTab")
}
