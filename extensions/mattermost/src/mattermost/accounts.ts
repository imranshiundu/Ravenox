...
export function listMattermostAccountIds(cfg: RavenoxConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: RavenoxConfig): string {
...
export function listEnabledMattermostAccounts(cfg: RavenoxConfig): ResolvedMattermostAccount[] {
