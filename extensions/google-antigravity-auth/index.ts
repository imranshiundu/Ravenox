...
const CLIENT_SECRET = process.env.RAVENOX_GOOGLE_CLIENT_SECRET || "";
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Ravenox Antigravity OAuth</title>
  </head>
  <body>
    <main>
...
async function loginAntigravity(params: {
  ...
  if (!CLIENT_ID || !CLIENT_SECRET) {
    throw new Error(
      "Missing Google OAuth credentials. Please set RAVENOX_GOOGLE_CLIENT_ID and RAVENOX_GOOGLE_CLIENT_SECRET environment variables.",
    );
  }
