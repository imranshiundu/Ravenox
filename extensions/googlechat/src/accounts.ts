...
export function listGoogleChatAccountIds(cfg: RavenoxConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: RavenoxConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: RavenoxConfig): ResolvedGoogleChatAccount[] {
