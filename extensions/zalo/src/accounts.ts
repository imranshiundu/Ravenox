...
export function listZaloAccountIds(cfg: RavenoxConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: RavenoxConfig): string {
...
function mergeZaloAccountConfig(cfg: RavenoxConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: RavenoxConfig): ResolvedZaloAccount[] {
