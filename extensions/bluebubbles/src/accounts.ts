...
export function listBlueBubblesAccountIds(cfg: RavenoxConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: RavenoxConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: RavenoxConfig): ResolvedBlueBubblesAccount[] {
