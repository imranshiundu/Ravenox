...
This directory contains the **BlueBubbles external channel plugin** for Ravenox.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and "@ravenox/plugin-sdk` helpers.
